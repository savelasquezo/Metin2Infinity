...
--]]
-- ########################################################################################
-- ### PASTE EVERYTHING INSIDE questlua.lib OR ONLY: (w/o --)
-- dofile(get_locale_base_path().."/quest/questlib__extra.lua")
-- ########################################################################################
if QUESTLIB_EXTRA_LUA==nil then QUESTLIB_EXTRA_LUA=1.0 -- include_guard begin
